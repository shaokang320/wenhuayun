    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu " id="side-menu">
                ...
                <li class="item">
                    <a href="#"><i class="fa fa-users"></i> <span class="nav-label">企业管理</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="{{route('admin_enterprise')}}">企业列表</a></li>
                        <li><a href="{{route('admin_enterprise_add')}}">企业添加</a></li>
                    </ul>
                </li>
            </ul>
            <script>
