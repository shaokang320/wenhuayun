...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = [
        ...
        'http://wenhua.newheightchina.com/enterprise/upload/upload_file',
        'http://wenhua.newheightchina.com/enterprise/upload/upload_video',
        'http://wenhua.newheightchina.com/enterprise/upload',
    ];
}
